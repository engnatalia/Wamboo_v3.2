...
class VideoCompressionWorker(private val context: Context, workerParams: WorkerParameters) :
    ...
    override fun doWork(): Result {
        ...
        //val selectedBitrate = Uri.parse(inputData.getString(ForegroundWorker.VIDEO_BITRATE))
       ...
       // serviceIntent.putExtra(ForegroundWorker.VIDEO_BITRATE, selectedBitrate.toString())
